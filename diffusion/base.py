...
class GaussianDiffusionBeatGans:
    ...
    def training_losses(self,
        ...
        if self.loss_type in [
            ...
            true_samples = torch.randn_like(model_forward.cond)
            loss_mmd = compute_mmd(true_samples, model_forward.cond)
            terms["loss"] += loss_mmd.repeat(terms["mse"].shape[-1])
        else:
    ...
    def p_mean_variance(self,
        ...
        :return: a dict with the following keys:
                 ...
                 - 'pred_xstart': the prediction for x_0.Apply the model to get p(x_{t-1} | x_t), as well as a prediction of
        the initial x, x_0.
