...
def ffhq128_autoenc_base():
    conf = autoenc_base()
    conf.data_name = 'ffhqlmdb256' #ffhqlmdb256
    conf.scale_up_gpus(4)
    conf.img_size = 128
    conf.net_ch = 128
...
def ffhq128_autoenc_130M():
    conf = ffhq128_autoenc_base()
    # here is the imgs for traing, not the itertaions


    conf.total_samples = 143_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    # conf.total_samples = 25_000_000
    # conf.eval_ema_every_samples = 2_500_000
    # conf.eval_every_samples = 2_500_000
    conf.name = 'ffhq128_130M'
    return conf
